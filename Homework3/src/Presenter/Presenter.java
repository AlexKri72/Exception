package Homework3.src.Presenter;

import java.io.File;
import java.io.FileWriter;
import java.io.IOException;

import Homework3.src.Model.ParsingDataStringException;
import Homework3.src.Model.DataChecker;
...
public class Presenter<V extends View> {
    ...
    // создаём или подключаемся к файлу по фамилии и дописываем туда новые данные
